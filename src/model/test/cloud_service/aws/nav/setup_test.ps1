...
aws s3 cp ./s3_test_data/full-clusterer-test/model.pkl s3://portamento-bucket/full-clusterer-test/model.pkl --endpoint-url=http://localhost:4566
aws s3 cp ./s3_test_data/full-clusterer-test/navigator-config.json s3://portamento-bucket/full-clusterer-test/navigator-config.json --endpoint-url=http://localhost:4566

# To try the online learning clusterer:
# Load the default folder: half_model.pkl and its data
...
aws s3 cp ./s3_test_data/online-learning-test/model.pkl s3://portamento-bucket/online-learning-test/model.pkl --endpoint-url=http://localhost:4566
aws s3 cp ./s3_test_data/online-learning-test/navigator-config.json s3://portamento-bucket/online-learning-test/navigator-config.json --endpoint-url=http://localhost:4566
